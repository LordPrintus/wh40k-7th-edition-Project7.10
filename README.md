...
Our motivation stems from the refusal to keep running the hamster wheel of new editions without having to discard our ability to keep adding and getting new minis. Freedom is the name of the game !
...
We are in no way affiliated with the Prohammer project, but we strongly suggest using the codices along with the ProHammer 2.4 ruleset !

ProHammer links
Dakka thread
https://www.dakkadakka.com/dakkaforum/posts/list/796101.page

Prohammer Discord server
